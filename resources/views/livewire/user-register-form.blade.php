 <div class="w-1/3 my-10">
     <div class="py-2">
         ...
         @if (session('success'))
             <div class="mt-6 p-4 mb-4 text-sm text-green-700 rounded-2xl bg-green-200" role="alert">
         ...
         <div class=" ">
             <form wire:submit="createNewUser" action="#" method="POST" class="space-y-6">
                 ...
                 <div class="col-span-full">
                     <label for="profile_picture" class="block text-sm/6 font-medium text-gray-900">Profile
                         Picture</label>
                             ...
                             <div class="mt-4 flex text-sm/6 text-gray-600">
                                 <label for="avatar"
                                     ...
                                     <input wire:model="avatar" id="avatar" type="file" name="avatar"
                                         class="sr-only" accept="image/png, image/jpg" />
                                 </label>
                 ...
                 <div wire:loading wire:target="avatar"
                     class="flex items-center justify-center bg-gray-50 border-gray-200 h-20 w-20 border border-default text-blue-700 text-xs font-medium rounded-base">
                     <div
                         class="px-2 py-px ring-1 ring-inset ring-brand-subtle text-blue-500 text-xs font-medium rounded bg-brand-softer animate-pulse">
                         loading...</div>
                 </div>
                 @if ($avatar)
                     <p class="my-2 text-sm font-medium">Preview</p>
                 ...
                 <div>
                     <button wire:click="createNewUser"
                         ...
                         <svg wire:loading wire:targe="createNewUser" aria-hidden="true"
